...
---
# Goal: 
Generate 3d voxel coordinates representing the outer surface (roughly the glomerular layer) for incorporation as a scaffold for the 3d statistical reconstruction of single dimension targeted transcriptomics data.
