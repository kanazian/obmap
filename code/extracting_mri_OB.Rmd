...
rescaledcc <- Rescale(trimpost_newmed, 23, 22, 22)
...
saveRDS(rescaledcc_out, "~/Desktop/obmap/r_analysis/mri_to_R/output/210428_cubegrid_rescaled_concaveMedial_outeronly.RDS")

#rescale OB with straight medial wall
rescaled <- Rescale(thicc, 23, 22, 22)
rescaled_out <- tibble(AntPos = rescaled$APint, 
                         MedLat = rescaled$MLint, 
                         VenDor = rescaled$VDint, type = "straight_medwall") %>%
  unique()
OBplot(rescaled_out)
saveRDS(rescaled_out, "~/Desktop/obmap/r_analysis/data/mri_to_R/210428_voxV4_strip25_straightMdoubled_outeronly_rescaled22dv.RDS")
```
