...
#load data
allmice_tpm <- read_csv("~/Desktop/obmap/r_analysis/3dimOB/input/covarintactchemo2_over_samples_210227.csv")

#make new covars
blankdata <- readRDS("~/Desktop/obmap/r_analysis/mri_to_R/output/210310_cubegrid_rescaled_outeronly.RDS")
...
m13_Onorm <- Ompnormify(m13_tpm)
m5_Onorm <- Ompnormify(m15_tpm)
...
m91214_voxsort <- MakeSort(m9_Vnorm, m12_Vnorm, m14_Vnorm, 
                            method = "posmean") %>%
